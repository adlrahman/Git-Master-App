...
async def search_users(request: SearchRequest = SearchRequest(query="adlrahman"), token: HTTPAuthorizationCredentials = Depends(verify_token)):
    """
    Search users on GitHub.
    Default query: "adlrahman"
    """
